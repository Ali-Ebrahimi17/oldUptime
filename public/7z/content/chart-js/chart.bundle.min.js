...
!(function(t, e) {
	...
	function Fi(t, e, i, n, a) {
		return t === n || t === a
			...
			: t < n || t > a ? { start: e - i, end: e } : { start: e, end: e + i }
	}
	function Ri(t) {
	...
	var Ji = fi.extend({
			...
			getPixelForOffset: function(t) {
				var e = this,
					...
					o =
						n * (e._offsets.start + r) / (e._offsets.start + 1 + e._offsets.end)
				return i ? a - o : a + o
			},
			...
			t.exports = (function() {
				...
				B('H', [ 'HH', 2 ], 0, 'hour'),
					...
					B('hmmss', 0, 0, function() {
						return (
							'' + te.apply(this) + N(this.minutes(), 2) + N(this.seconds(), 2)
						)
					}),
					B('Hmm', 0, 0, function() {
						...
						return null != t
							? ((t = (function(t, e) {
									return 'string' != typeof t
										? t
										: isNaN(t)
											? 'number' == typeof (t = e.weekdaysParse(t)) ? t : null
											: parseInt(t, 10)
								})(t, this.localeData())),
								this.add(t - e, 'd'))
							: e
					...
					(_i.longDateFormat = function(t) {
						...
						return e || !i
							...
							: ((this._longDateFormat[
									t
								] = i.replace(/MMMM|MM|DD|dddd/g, function(t) {
									return t.slice(1)
								})),
					...
					(_i.monthsParse = function(t, e, i) {
						...
						if (this._monthsParseExact)
							return function(t, e, i) {
								...
								return i
									? 'MMM' === e
										? -1 !== (a = Ct.call(this._shortMonthsParse, o)) ? a : null
										: -1 !== (a = Ct.call(this._longMonthsParse, o)) ? a : null
									: 'MMM' === e
					...
					(_i.weekdaysParse = function(t, e, i) {
						...
						if (this._weekdaysParseExact)
							return function(t, e, i) {
								...
								return i
									? 'dddd' === e
										? -1 !== (a = Ct.call(this._weekdaysParse, o)) ? a : null
										: 'ddd' === e
						...
						return i < -6
							...
							: i < -1
								...
								: i < 0
									...
									: i < 1
										? 'sameDay'
										: i < 2 ? 'nextDay' : i < 7 ? 'nextWeek' : 'sameElse'
					}),
					(n.prototype = bi),
					(n.HTML5_FMT = {
